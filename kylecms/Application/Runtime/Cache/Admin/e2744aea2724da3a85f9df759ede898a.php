...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <script src="/kylecms/Public/js/kindeditor/kindeditor-all.js"></script>
  <div id="page-wrapper">
...
<script>
  var SCOPE = {
    ...
    'ajax_upload_swf' : '/kylecms/Public/js/party/uploadify.swf',
  };

</script>
<!-- /#wrapper -->
<script src="/kylecms/Public/js/admin/image.js?ver=2.2"></script>
<script>
  // 6.2
